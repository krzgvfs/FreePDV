...
from .viewer import template, login, register, logout, vendas, caixas, estatistica, estoques, home, produtos, usuarios, pdv, combo

# Registro das rotas
webui_bp.add_url_rule("/", view_func=template)
